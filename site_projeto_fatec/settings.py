"""
Django settings for site_projeto_fatec project.
...
#SECRET_KEY = 'django-insecure-=!=fn11ng8u=usdv-0a6@+o38^gwiuv)2ss$avo9ufg9v4z6i*'
...
ROOT_URLCONF = 'site_projeto_fatec.urls'
...
WSGI_APPLICATION = 'site_projeto_fatec.wsgi.application'
